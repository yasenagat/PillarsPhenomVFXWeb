...
![流程图](image/post_mg_pipeline.png)
...
![导入素材对话框](image/post_mg_add_source_library.png)
...
![创建组对话框](image/post_mg_add_source_group.png)
...
![添加镜头对话框](image/post_mg_add_shot.png)
...
![添加镜头列表对话框](image/post_mg_add_shotgroup.png)
...
![添加外包列表对话框](image/post_mg_add_vendorlist.png)
