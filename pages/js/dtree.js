...
dTree.prototype.node = function(node, nodeId) {
	if(node.target=="0"){//底层节点
		var str = '<div class="dTreeNode">' + this.indent(node, nodeId)+'<span class=\''+node.id+'\'>+<div><ul><li class="addGroup">创建素材组</li><li class="removeGroup">删除素材组</li><li class="addMaterial">添加素材</li><li class="removeMaterial">移除素材</li><li class="updGroup">修改</li></ul></div></span>';
	}else{//非底层节点
		var str = '<div class="dTreeNode">' + this.indent(node, nodeId)+'<span class=\''+node.id+'\'>+<div><ul><li class="addGroup">创建素材组</li><li class="removeGroup">删除素材组</li><li class="addMaterial">添加素材</li><li class="removeMaterial">移除素材</li><li class="updGroup">修改</li></ul></div></span>';
	}
